...
import imgUser from '../images/cj.jfif'
  ...
  return (
    <Nav>
        ...
        { !userName ? (
            ...
            <a>
                <img src= {imgWatchlistIcon}/>
                <span>WATCHLIST</span>
            </a>
            <a>
                <img src= {imgOriginalIcon}/>
                <span>ORIGINALS</span>
            </a>
            <a>
                <img src= {imgMovieIcon}/>
                <span>MOVIES</span>
            </a>
            <a>
                <img src= {imgSeriesIcon}/>
                <span>SERIES</span>
            </a>

        </NavMenu>
        <UserImg onClick={signOut} src= {imgUser}/>
            </>
            )
        }
